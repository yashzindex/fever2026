...
const ThisFever = () => {
  return (
    <section className="relative pt-10 md:pt-16 xl:pt-20 pb-7 sm:pb-10 md:pb-14 xl:pb-20 2xl:py-24">
      <div className="container">
        <div className="sm:px-6 xl:px-14">
          <p className="text-sm tracking-[0.14px] mb-4">This is Fever</p>
